...
SELECT id,tenant_id,'a2100000-0000-4000-8000-000000000001',2
FROM naming_rules
WHERE tenant_id='a2000000-0000-4000-8000-000000000001'
  AND asset_type_code IN ('MDF','IDF','RACK','PATCH_PANEL','SWITCH','PDU','UPS','BACKBONE');
