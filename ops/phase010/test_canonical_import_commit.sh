...
container="skia-b3b5-commit-$$"
password="b3b5_commit_test_only"
...
INSERT INTO tenants(id,name) VALUES
 ('91000000-0000-4000-8000-000000000001','Canonical commit tenant'),
 ('91000000-0000-4000-8000-000000000002','Foreign commit tenant');
INSERT INTO users(id,email,name,password_hash,status) VALUES
 ('93000000-0000-4000-8000-000000000001','canonical-commit@example.test','Canonical committer','x','active');
INSERT INTO branches(id,tenant_id,code,name,status) VALUES
 ('92000000-0000-4000-8000-000000000001','91000000-0000-4000-8000-000000000001','TJ','Authorized','active'),
 ('92000000-0000-4000-8000-000000000002','91000000-0000-4000-8000-000000000001','B2','Other branch','active'),
 ('92000000-0000-4000-8000-000000000003','91000000-0000-4000-8000-000000000002','OT','Other tenant','active');
...
INSERT INTO zones(id,tenant_id,branch_id,code,name,status) VALUES
 ...
 ('94000000-0000-4000-8000-000000000004','91000000-0000-4000-8000-000000000001','92000000-0000-4000-8000-000000000001','MISMATCH','Mismatch','active'),
...
INSERT INTO naming_rules(id,tenant_id,asset_type_code,prefix,separator,include_branch,include_site,include_internal_area,include_zone,context_mode,seq_digits,last_seq,active) VALUES
 ('95000000-0000-4000-8000-000000000001','91000000-0000-4000-8000-000000000001','MDF','MDF','-',true,false,false,true,'CANONICAL_ZONE',3,0,true),
 ('95000000-0000-4000-8000-000000000002','91000000-0000-4000-8000-000000000001','IDF','IDF','-',true,false,false,true,'CANONICAL_ZONE',3,0,true);
SQL
...
export GOCACHE="${TMPDIR:-/tmp}/skia-b3b5-integration-go-cache"
(cd "$repo_root/backend" && go test -v -race -tags integration -run '^TestCanonicalImportCommitPostgreSQL16$' ./...)

echo "CANONICAL_IMPORT_COMMIT_POSTGRES=PASS"
