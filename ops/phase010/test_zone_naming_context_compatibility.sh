...
docker exec "$container" sh -c \
  "cp /repo/ops/phase010/bootstrap.manifest /tmp/bootstrap.manifest.full && sed '/026_zone_naming_context_compatibility.sql/d' /tmp/bootstrap.manifest.full > /repo/ops/phase010/bootstrap.manifest"
