...
prepare_pre035() {
  ...
  docker exec "$container" sh -ceu \
    "cp -a /repo /repo-pre035; sed -i '/035_remove_legacy_rack_authorities.sql/d' /repo-pre035/ops/phase010/bootstrap.manifest"
...
grep -q '^LEDGER_COUNT=27$' <<<"$clean_output"
grep -q '^SCHEMA_HASH=8712fcae88f98f7c75605772ab88cbeb52d06e022c07a8782b045e33caec0c10$' <<<"$clean_output"
