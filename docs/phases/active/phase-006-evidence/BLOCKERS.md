...
| P006-B03 | BLOQUEADO EN PREFLIGHT | Gate de cutover aprobado, pero no existe una credencial externa identificable para `skia_runtime` ni configuración separada `MIGRATOR_DATABASE_URL`; no se autoriza extraer/reutilizar el secreto runtime actual | Provisionamiento externo seguro y nuevo intento autorizado |
