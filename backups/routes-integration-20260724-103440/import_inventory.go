...
func handleImportInventory(w http.ResponseWriter, r *http.Request) {
	...
	// Guardar activos
	err = SaveAssetsToDB(importID, sessionCtx.TenantID, sessionCtx.UserID, assetType, cleanedItems)
	if err != nil {
...
func handleImportStats(w http.ResponseWriter, r *http.Request) {
	...
	stats, err := GetImportStatsToDB(sessionCtx.TenantID)
	if err != nil {
...
func handleRecentImports(w http.ResponseWriter, r *http.Request) {
	...
	imports, err := GetRecentImportsToDB(sessionCtx.TenantID, 10)
	if err != nil {
